...
//		return self.player.nowPlayingItem != nil
    }
...
//		return self.player.nowPlayingItem == nil
	...
	public func getNextSong() -> MPMediaItem? {
		
		guard ((player.indexOfNowPlayingItem + 1) < self.songsCollection.count) else { return nil }
		
		return self.songsCollection.items[player.indexOfNowPlayingItem + 1]
	}

	public func getPreviousSong() -> MPMediaItem? {
		
		guard (player.indexOfNowPlayingItem > 0) else { return nil }
