...
class MTAlbumData: MTData, Identifiable {
	...
	func durationText() -> String {
		var retDuration: String = ""
		
		retDuration = (self.playTime.hours > 0) ? "\(self.playTime.hours):" : ""
		retDuration = retDuration + String(format: "%02i:%02i", self.playTime.minutes, self.playTime.seconds)
